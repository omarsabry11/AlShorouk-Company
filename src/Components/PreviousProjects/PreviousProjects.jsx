              ...
              <a href="">
                <div className="border-[3px] border-gray-300 rounded-xl p-3 h-full">
                  ...
                  <div className="py-2">
                    ...
                    <p className="font-semibold flex leading-7"><i class="fa-solid fa-angle-left mt-2 me-1"></i>  شركة إيطالية رائدة في تصنيع إطارات الشاحنات والحافلات والمعدات الزراعية، تُعرف بجودتها العالية ومقاومتها للأضرار والتآكل. تُقدم بروميتيون مجموعة واسعة من الإطارات التي تناسب مختلف الاستخدامات والتضاريس.</p>
                  </div>
